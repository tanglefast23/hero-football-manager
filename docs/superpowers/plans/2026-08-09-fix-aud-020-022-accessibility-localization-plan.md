...
- `npx jest src/i18n --runInBand`: 18 suites and 144 tests passed.
- The focused AUD, formatter, application, ceremony, event, and 44-point suites
  passed together: 14 suites and 183 tests.
- `npx jest --runInBand`: 425 suites and 3,970 tests passed; one existing
  suite/test was skipped, and all three snapshots passed.
