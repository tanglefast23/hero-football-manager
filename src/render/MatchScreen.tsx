  ...
  useEffect(() => {
    ...
    const loop = (now: number) => {
      ...
      for (const e of newEvents) {
        ...
        // The banner above stays slide-only on purpose: a banner is a queue and
        // would bury itself, while this card lives 620ms on the grass where it
        // happened and is gone.
