...
export function homeProductAlerts(state: GameState): ClubAlertViewModel[] {
  ...
  return [
    ...
    // The heads-up, one season ahead of the announcement above. One-shot, so it
    // lands the week it is discovered and then leaves the three desk slots to
    // injuries and board deadlines; the player card carries it from then on.
    ...roster
