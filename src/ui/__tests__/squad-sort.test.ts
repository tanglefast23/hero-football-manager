...
const players = [
  { id: '1', name: 'Sam Mitts', role: 'GK' as const, overall: 43, projectedOverall: 78, condition: 100 },
  { id: '2', name: 'Ed Stone', role: 'DEF' as const, overall: 45, projectedOverall: 84, condition: 75 },
  { id: '3', name: 'Bo Hedges', role: 'DEF' as const, overall: 45, projectedOverall: 84, condition: 100 },
  { id: '4', name: 'Gio Marsh', role: 'MID' as const, overall: 50, projectedOverall: 97, condition: 60 },
];
