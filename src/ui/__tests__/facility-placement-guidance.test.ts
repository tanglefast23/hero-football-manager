...
describe('first facility placement guidance', () => {
  ...
  it('reveals the placement grid with a helper after any mobile build choice', () => {
    ...
    expect(source).toContain("{t('clubFinances.tapHereToPlace')}");
    ...
    expect(source).toContain('styles.facilityPlacementHelper');
    expect(source).toContain('styles.guidedFacilityGlow');
    expect(source).toContain('border-gold-dark bg-gold-light');
    expect(source).toContain('onPointerMove={dismissFacilityPlacementHelper}');
    expect(source).toContain('onTouchStart={dismissFacilityPlacementHelper}');
