 ...
 * and an optional explanatory tip, while preserving its own styles.
 *
    ...
    <NativePressable
      ...
      style={(() => {
        ...
        return [
          ...
          // Keep the responder's hit box fixed for the whole gesture. Moving it
          // on press-in can make React Native cancel the pending onPress.
