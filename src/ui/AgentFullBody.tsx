  ...
  return (
    ...
    >
      ...
      >
        {groundShadow ? (
          <View
            style={[styles.groundShadow, raise(1, frame, 'groundShadow')]}
          />
        ) : null}
        ...
        {showPresenting ? (
          ...
          <>
            ...
            <View
              style={[styles.hangingCaseHandle, drop(141, frame, 'leftHand')]}
            />
            <View style={[styles.hangingCase, drop(146, frame, 'leftHand')]} />
            <View
              style={[styles.hangingCaseClasp, drop(154, frame, 'leftHand')]}
            />
          </>
        )}
