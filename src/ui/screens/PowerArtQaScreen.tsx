  ...
  return (
    ...
    >
      ...
      <View style={[styles.content, compact ? styles.contentCompact : null]}>
        ...
        <View
          accessibilityLabel={t('powerArtQa.a11y.animationPreview', {
            name,
            description,
          })}
          style={[
        ...
        <View style={[styles.infoRail, { width: stageWidth }]}>
          ...
          <Text numberOfLines={compact ? 3 : 2} style={styles.description}>
            {description}
          </Text>
        </View>
        ...
        <View style={[styles.navigation, { width: stageWidth }]}>
          <ReviewButton
            label="◂ PREVIOUS"
            accessibilityLabel={t('powerArtQa.a11y.showPreviousPower')}
            onPress={onPrevious}
          />
          <ReviewButton
            label="↻ REPLAY"
            accessibilityLabel={t('powerArtQa.a11y.replayAnimation', { name })}
            onPress={onReplay}
            hero
          />
          <ReviewButton
            label="NEXT ▸"
            accessibilityLabel={t('powerArtQa.a11y.showNextPower')}
            onPress={onNext}
          />
        </View>
      </View>
...
function ReviewButton({
  ...
  return (
    ...
    >
      <Text
        style={[styles.navigationText, hero ? styles.navigationTextHero : null]}
      >
        {label}
      </Text>
    </Pressable>
