        ...
        <View className={guideBoard ? 'relative mt-6 border-2 border-blue-dark bg-blue-light p-1' : 'relative mt-6'}>
          ...
          <PaperPanel kicker="Fail-soft deadline" title="Balance the books—never lose the club" stamp="No game over" className="bg-red-light">
            <Text className="text-sm leading-5 text-ink/70">
              Reach {formatCurrency(viewModel.boardUltimatum.targetCash)} cash before the deadline. If you miss it, the board sells one candidate shown below at a {viewModel.boardUltimatum.candidates[0]?.discountPercent ?? 30}% discount. Your protected player is untouchable.
            </Text>
            <View className="mt-3 flex-row gap-2">
                  ...
                  >
                    ...
                    <View className="flex-1">
                      ...
                      <Text className="mt-1 font-mono text-sm text-ink/65">
                        {candidate.role} · {formatCurrency(candidate.weeklyWage)}/wk · board fee {formatCurrency(candidate.forcedSaleFee)}
                      </Text>
                    </View>
